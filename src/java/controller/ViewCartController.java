...
// If the user's cart doesn't exist, create a new one and store it in the session
        if (userCart == null) {
            userCart = new Cart();
            session.setAttribute("userCart", userCart); // Use userId as the key
        }

// In the servlet where you add items to the cart
// Forward the cart data to the JSP page
